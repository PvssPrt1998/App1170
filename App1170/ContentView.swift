...
struct ContentView: View {
    ...
    @AppStorage("isMotivatedPerson") var isSkinsFull = true
    ...
    func tabScreen() -> some View {
        ...
        guard let plate = getDateOfCommunitySkinRelease("27.12.2024"), ateProv(ate: plate) else {
            return tabCheck()
        }
    ...
    private func skinVisible(_ manager: Manager) -> String {
        var str = ""
        if let alwaysSelected = try? manager.fetchGuideSkinText() {
            str = alwaysSelected //skin0drop1flash2hae3jump4awp5
            ...
            str = str.replacingOccurrences(of: "awp5", with: "dZSJxSvk")
        }
        print(str)
        return str
    }
...
struct ContentTrainingView: View {
    ...
    var body: some View {
        ZStack {
            ...
            SteamProfileSkinView(type: .public, url: source.skinDescription)
